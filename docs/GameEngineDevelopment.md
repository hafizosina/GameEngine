# Game Engine Development Plan — Phase by Phase
...
Which phase do you want to start on? I can write the actual CMakeLists, folder scaffold, or first real code for Phase 0.